...
// Configure for connector server
app.configure('production|development', 'connector', function() {
	// load session configures
	logger.info('xssssss')
	app.set('playerService', new PlayerService(app));
});
...
// Configure for player server
app.configure('production|development', 'player', function() {
	app.set('playerService', new PlayerService(app));
});
